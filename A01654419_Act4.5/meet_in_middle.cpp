...
void meet_algorithm(std::vector<double> a, std::vector<double> b)
{
	std::cout << "Doing other stuff\n";
}

void meet_in_mid(std::vector<double> arr)
{
	...
	/* std::vector<double> res_a = search();// Search in a */
	/* std::vector<double> res_b = search();// Search in a */

	/* // Meet in middle */
	/* meet_algorithm(res_a, res_b); */
...
int main()
{
	...
	while (true)
	{
		...
		std::cout << "Program will search for the number " << sum_num << "\n";
